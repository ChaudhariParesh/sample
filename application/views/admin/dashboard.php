          ...
          <div class="row">
              ...
              <div class="card card-statistic-2">
                  ...
                  <div class="card-stats-title">
                   <!--  <div class="dropdown d-inline">
                      ...
                      <ul class="dropdown-menu dropdown-menu-sm">
                        ...
                        <li><a href="<?=base_url();?>" class="dropdown-item">January</a></li>
                ...
                <div class="card-wrap">
                  <div class="card-header">
                    <h3><a href="<?=base_url();?>list_contact">Contact List:<?=$total_contact?></a></h3>
                  </div>
                 <!-- <div class="card-body">
                    59
                  </div>-->
			...
			<div class="col-lg-4 col-md-4 col-sm-12">
              <div class="card card-statistic-2">
                ...
                <div class="card-wrap">
                  <div class="card-header">
                    <h3><a href="<?=base_url();?>list_enquiry">Enquiry List:<?=$total_enquiry?></a></h3>
                  </div>
                 <!-- <div class="card-body">
                    59
                  </div>-->
            ...
            <div class="col-lg-4 col-md-4 col-sm-12">
              <div class="card card-statistic-2">
                ...
                <div class="card-wrap">
                  <div class="card-header">
                    <h3><a href="<?=base_url();?>list_property">Property List</a></h3>
                  </div>
                 <!-- <div class="card-body">
                    59
                  </div>-->
